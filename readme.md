...
<br>
<ul>
          <li><a href='https://github.com/JailsonS/managerbooks'> Manage Books - web application (PHP, MySQL)</a></li>
          <li><a href='https://monitoramento.semas.pa.gov.br/ldi/'> Web application for management of environmental licenses (Java, PostgreSQL)</a></li>
          <li> Logging Mapping using Artificial Intelligence (Python, Tensorflow, Google Cloud)</li>
          <li><a href='https://github.com/JailsonS/app-ee-mapbox'> App View for geospatial visualization of google earth engine layer (JavaScript, Mapbox)</a></li>
          <li><a href='https://github.com/JailsonS/deledela'> Client warnings (Flask, Python, Oracle) </a></li>
          <li><a href='https://github.com/JailsonS/mapbiomas-alerta-download'>Request deforestation data </a> from <a href='https://plataforma.alerta.mapbiomas.org/mapa?monthRange[0]=2019-01&monthRange[1]=2024-01&sources[0]=All&territoryType=all&authorization=all&embargoed=all&locationType=alert_code&activeBaseMap=7&map=-14.288794%2C-54.297494%2C4'>Mapbiomas Alerta</a> </li>
          <li><a href='https://code.earthengine.google.com/5fcdf54a7d6b41cb278dde02ecef657f'> Earth Engine App for drawing selective logging areas </a></li>
</ul>
<br>
